Foreman::Plugin.register :katello do
  ...
  parameter_filter ::Host::Managed, :host_collection_ids => [],
    :content_facet_attributes => [:content_view_id, :lifecycle_environment_id, :content_source_url_id,
  ...
  parameter_filter Hostgroup, :content_view_id, :lifecycle_environment_id, :content_source_url_id,
  ...
  register_facet Katello::Host::ContentFacet, :content_facet do
    ...
    template_compatibility_properties :content_source_url_id, :content_source_url
  end
